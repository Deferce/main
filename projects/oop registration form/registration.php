...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Anton&family=Playfair+Display&family=Roboto+Condensed&family=Vina+Sans&family=Work+Sans&display=swap" rel="stylesheet">
...
<body>
    ...
    <form method="POST" action="./includes/handler.php">
        ...
        </div><a class='btn' href="./login.php">Already Have Account?</a>
        <div class="error">
            <?php
        ...
        function errorValidation($val)
        {
            ...
            if ($val == 'dublicateUser') {
                echo "This username already exists, please pick another one";
            }
            if ($val == 'dublicateEmail') {
                echo "This email already exists, please pick another one";
            }
        }
