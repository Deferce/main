...
<script type="text/javascript" src="/web/JunTest scandiweb/js/main.js"></script>
...
if (!$selectDB) {
    ...
    print_r("<span id='connectionDbStatus'>" . "Current database: " . $fetchDatabase[0] . "</span>");
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Query requests
